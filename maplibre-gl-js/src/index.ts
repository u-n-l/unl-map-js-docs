 ...
 * }
 * @see [Check for browser support](https://u-n-l.github.io/unl-map-js-docs/example/check-for-support/)
 */
 ...
 * @see [Add support for right-to-left scripts](https://u-n-l.github.io/unl-map-js-docs/example/mapbox-gl-rtl-text/)
 */
