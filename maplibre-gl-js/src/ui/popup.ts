 ...
 *   .setMaxWidth("300px")
 *   .addTo(map);
 * @see [Display a popup](https://u-n-l.github.io/unl-map-js-docs/example/popup/)
 ...
 * @see [Attach a popup to a marker instance](https://u-n-l.github.io/unl-map-js-docs/example/set-popup/)
 */
export default class Popup extends Evented {
   ...
   * @see [Display a popup on hover](https://u-n-l.github.io/unl-map-js-docs/example/popup-on-hover/)
   * @see [Display a popup on click](https://u-n-l.github.io/unl-map-js-docs/example/popup-on-click/)
   * @see [Show polygon information on click](https://u-n-l.github.io/unl-map-js-docs/example/polygon-popup-on-click/)
   */
  addTo(map: Map) {
    ...
    if (!this._container) {
      ...
      if (this.options.className) {
        this.options.className
          .split(" ")
          .forEach((name) => this._container.classList.add(name));
      }
