 ...
 *   zoom: 10
 * });
 * @see [Set pitch and bearing](https://u-n-l.github.io/unl-map-js-docs/example/set-perspective/)
 * @see [Jump to a series of locations](https://u-n-l.github.io/unl-map-js-docs/example/jump-to/)
 * @see [Fly to a location](https://u-n-l.github.io/unl-map-js-docs/example/flyto/)
 * @see [Display buildings in 3D](https://u-n-l.github.io/unl-map-js-docs/example/3d-buildings/)
 */
...
abstract class Camera extends Evented {
   ...
   * @fires moveend
   * @returns {Map} `this`
   * @see [Navigate the map with game-like controls](https://u-n-l.github.io/unl-map-js-docs/example/game-controls/)
   */
   ...
   * @see [Update a feature in realtime](https://u-n-l.github.io/unl-map-js-docs/example/live-update-feature/)
   */
  ...
  _cameraForBoxAndBearing(
    ...
    const rotatedPaddingOffset = paddingOffset.rotate(
      (bearing * Math.PI) / 180
    );
   ...
   * });
   * @see [Fly to a location](https://u-n-l.github.io/unl-map-js-docs/example/flyto/)
   * @see [Slowly fly to a location](https://u-n-l.github.io/unl-map-js-docs/example/flyto-options/)
   * @see [Fly to a location based on scroll position](https://u-n-l.github.io/unl-map-js-docs/example/scroll-fly-to/)
   */
