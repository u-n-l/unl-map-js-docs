 ...
 * the schema described in the [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/), or a URL to
 * such JSON.
 *
 *
 ...
 *   The purpose of this option is to avoid bandwidth-intensive glyph server requests. (See [Use locally generated ideographs](https://u-n-l.github.io/unl-map-js-docs/example/local-ideographs).)
 ...
 *   }
 * });
 * @see [Display a map](https://u-n-l.github.io/unl-map-js-docs/example/simple-map/)
 */
class Map extends Camera {
   ...
   * @see [Display map navigation controls](https://u-n-l.github.io/unl-map-js-docs/example/navigation/)
   */
   ...
   * @see [Render world copies](https://u-n-l.github.io/unl-map-js-docs/example/render-world-copies/)
   */
   ...
   *     source: {
   *       type: 'vector',
   *       url: 'https://u-n-l.github.io/unl-map-js-docs/style-spec/'
   *     },
   ...
   *     .addTo(map);
   * });
   * @see [Display popup on click](https://u-n-l.github.io/unl-map-js-docs/example/popup-on-click/)
   * @see [Center the map on a clicked symbol](https://u-n-l.github.io/unl-map-js-docs/example/center-on-symbol/)
   * @see [Create a hover effect](https://u-n-l.github.io/unl-map-js-docs/example/hover-styles/)
   * @see [Create a draggable marker](https://u-n-l.github.io/unl-map-js-docs/example/drag-a-point/)
   */
   ...
   * @param {Array<string>} [options.layers] An array of [style layer IDs](https://u-n-l.github.io/unl-map-js-docs/style-spec/#layer-id) for the query to inspect.
   *   Only features within these layers will be returned. If this parameter is undefined, all layers will be checked.
   * @param {Array} [options.filter] A [filter](https://u-n-l.github.io/unl-map-js-docs/style-spec/layers/#filter)
   ...
   * @see [Get features under the mouse pointer](https://u-n-l.github.io/unl-map-js-docs/example/queryrenderedfeatures/)
   */
   ...
   * @param {Array} [parameters.filter] A [filter](https://u-n-l.github.io/unl-map-js-docs/style-spec/layers/#filter)
   *   to limit query results.
   ...
   *   [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/), or a URL to such JSON.
   * @param {Object} [options] Options object.
   ...
   *
   * @example
   * map.setStyle("https://demotiles.u-n-l.github.io/style.json");
   *
   */
  setStyle(
   ...
   * MapLibre Style Specification's [source definition](https://u-n-l.github.io/unl-map-js-docs/style-spec/#sources) or
   ...
   *   type: 'vector',
   *   url: 'https://demotiles.u-n-l.github.io/tiles/tiles.json'
   * });
   * @example
   * map.addSource('my-data', {
   *   "type": "geojson",
   ...
   *   }
   * });
   * @see GeoJSON source: [Add live realtime data](https://u-n-l.github.io/unl-map-js-docs/example/live-geojson/)
   */
   ...
   * [Sources](https://u-n-l.github.io/unl-map-js-docs/style-spec/sources/) page.
   * @example
   * var sourceObject = map.getSource('points');
   * @see [Create a draggable point](https://u-n-l.github.io/unl-map-js-docs/example/drag-a-point/)
   * @see [Animate a point](https://u-n-l.github.io/unl-map-js-docs/example/animate-point-along-line/)
   * @see [Add live realtime data](https://u-n-l.github.io/unl-map-js-docs/example/live-geojson/)
   */
   ...
   * [`icon-image`](https://u-n-l.github.io/unl-map-js-docs/style-spec/#layout-symbol-icon-image),
   * [`background-pattern`](https://u-n-l.github.io/unl-map-js-docs/style-spec/#paint-background-background-pattern),
   * [`fill-pattern`](https://u-n-l.github.io/unl-map-js-docs/style-spec/#paint-fill-fill-pattern),
   * or [`line-pattern`](https://u-n-l.github.io/unl-map-js-docs/style-spec/#paint-line-line-pattern).
   ...
   *
   *
   * @see Use `HTMLImageElement`: [Add an icon to the map](https://u-n-l.github.io/unl-map-js-docs/example/add-image/)
   * @see Use `ImageData`: [Add a generated icon to the map](https://u-n-l.github.io/unl-map-js-docs/example/add-image-generated/)
   */
  addImage(
    id: string,
    image:
   ...
   * });
   *
   * @see [Add an icon to the map](https://u-n-l.github.io/unl-map-js-docs/example/add-image/)
   */
  ...
  /**
   * Adds a [MapLibre style layer](https://u-n-l.github.io/unl-map-js-docs/style-spec/#layers)
   * to the map's style.
   *
   * A layer defines how data from a specified source will be styled. Read more about layer types
   * and available paint and layout properties in the [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/#layers).
   *
   * @param {Object | CustomLayerInterface} layer The layer to add, conforming to either the MapLibre Style Specification's [layer definition](https://u-n-l.github.io/unl-map-js-docs/style-spec/#layers) or, less commonly, the {@link CustomLayerInterface} specification.
   ...
   * A list of layer types is available in the [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/layers/#type).
   *
   ...
   * Reference a _new source_ using a source object (as defined in the [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/sources/)) directly.
   ...
   * The MapLibre Style Specification includes more information on the limitations of the [`filter`](https://u-n-l.github.io/unl-map-js-docs/style-spec/layers/#filter) parameter
   * and a complete list of available [expressions](https://u-n-l.github.io/unl-map-js-docs/style-spec/expressions/).
   ...
   * A full list of paint properties for each layer type is available in the [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/layers/).
   ...
   * A full list of layout properties for each layer type is available in the [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/layers/).
   ...
   * }, 'cities');
   *
   * @see [Create and style clusters](https://u-n-l.github.io/unl-map-js-docs/example/cluster/)
   * @see [Add a vector tile source](https://u-n-l.github.io/unl-map-js-docs/example/vector-source/)
   * @see [Add a WMS source](https://u-n-l.github.io/unl-map-js-docs/example/wms/)
   */
  addLayer(
   ...
   *
   * @see [Filter symbols by toggling a list](https://u-n-l.github.io/unl-map-js-docs/example/filter-markers/)
   * @see [Filter symbols by text input](https://u-n-l.github.io/unl-map-js-docs/example/filter-markers-by-input/)
   */
   ...
   * [minimum zoom level](https://u-n-l.github.io/unl-map-js-docs/style-spec/#layer-minzoom)
   * and [maximum zoom level](https://u-n-l.github.io/unl-map-js-docs/style-spec/#layer-maxzoom))
   ...
   *   [filter definition](https://u-n-l.github.io/unl-map-js-docs/style-spec/layers/#filter).  If `null` or `undefined` is provided, the function removes any existing filter from the layer.
   * @param {Object} [options] Options object.
   ...
   *
   * @see [Create a timeline animation](https://u-n-l.github.io/unl-map-js-docs/example/timeline-animation/)
   */
  setFilter(
    layerId: string,
   ...
   *   Must be of a type appropriate for the property, as defined in the [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/).
   * @param {Object} [options] Options object.
   ...
   * @see [Change a layer's color with buttons](https://u-n-l.github.io/unl-map-js-docs/example/color-switcher/)
   * @see [Create a draggable point](https://u-n-l.github.io/unl-map-js-docs/example/drag-a-point/)
   */
  setPaintProperty(
    layerId: string,
   ...
   * @param {*} value The value of the layout property. Must be of a type appropriate for the property, as defined in the [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/).
   * @param {Object} [options] Options object.
   * @param {boolean} [options.validate=true] Whether to check if `value` conforms to the MapLibre GL Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
   * @returns {Map} `this`
   * @example
   ...
   *
   * @param light Light properties to set. Must conform to the [MapLibre Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/#light).
   * @param {Object} [options] Options object.
   * @param {boolean} [options.validate=true] Whether to check if the filter conforms to the MapLibre GL Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
   * @returns {Map} `this`
   * @example
   ...
   * - For vector or GeoJSON sources, using the [`promoteId`](https://u-n-l.github.io/unl-map-js-docs/style-spec/sources/#vector-promoteId) option at the time the source is defined.
   * - For GeoJSON sources, using the [`generateId`](https://u-n-l.github.io/unl-map-js-docs/style-spec/sources/#geojson-generateId) option to auto-assign an `id` based on the feature's index in the source data. If you change feature data using `map.getSource('some id').setData(..)`, you may need to re-apply state taking into account updated `id` values.
   *
   * _Note: You can use the [`feature-state` expression](https://u-n-l.github.io/unl-map-js-docs/style-spec/expressions/#feature-state) to access the values in a feature's state object for the purposes of styling._
   *
   ...
   * Features are identified by their `feature.id` attribute, which can be any number or string.
   *
   * _Note: To access the values in a feature's state object for the purposes of styling the feature, use the [`feature-state` expression](https://u-n-l.github.io/unl-map-js-docs/style-spec/expressions/#feature-state)._
   *
   * @param {Object} feature Feature identifier. Feature objects returned from
   * {@link Map#queryRenderedFeatures} or event handlers can be used as feature identifiers.
   * @param {string | number} feature.id Unique id of the feature.
   ...
   * @see [Measure distances](https://u-n-l.github.io/unl-map-js-docs/example/measure/)
   * @see [Display a popup on hover](https://u-n-l.github.io/unl-map-js-docs/example/popup-on-hover/)
   * @see [Center the map on a clicked symbol](https://u-n-l.github.io/unl-map-js-docs/example/center-on-symbol/)
   */
  getCanvas() {
    return this._canvas;
   ...
   * @example
   * map.triggerRepaint();
   * @see [Add a 3D model](https://u-n-l.github.io/unl-map-js-docs/example/add-3d-model/)
   * @see [Add an animated icon to the map](https://u-n-l.github.io/unl-map-js-docs/example/add-image-animated/)
   */
  triggerRepaint() {
