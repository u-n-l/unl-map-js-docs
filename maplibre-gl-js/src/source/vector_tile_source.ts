 ...
 * (See the [Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/) for detailed documentation of options.)
 *
 * @example
 ...
 *
 * @example
 * map.getSource('some id').setUrl("https://demotiles.u-n-l.github.io/tiles/tiles.json");
 *
 * @example
 * map.getSource('some id').setTiles(['https://d25uarhxywzl1j.cloudfront.net/v0.1/{z}/{x}/{y}.mvt']);
 * @see [Add a vector tile source](https://u-n-l.github.io/unl-map-js-docs/example/vector-source/)
 * @see [Add a third party vector tile source](https://u-n-l.github.io/unl-map-js-docs/example/third-party/)
 */
