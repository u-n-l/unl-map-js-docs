 ...
 * (See the [Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/#sources-geojson) for detailed documentation of options.)
 *
 * @example
 ...
 * @see [Add a GeoJSON line](https://u-n-l.github.io/unl-map-js-docs/example/geojson-line/)
 * @see [Create a heatmap from points](https://u-n-l.github.io/unl-map-js-docs/example/heatmap/)
    ...
    this.workerOptions = extend(
      {
        ...
        geojsonVtOptions: {
          ...
          tolerance:
            (options.tolerance !== undefined ? options.tolerance : 0.375) *
            scale,
          extent: EXTENT,
