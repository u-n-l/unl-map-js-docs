 ...
 * (See the [Style Specification](https://u-n-l.github.io/unl-map-js-docs/style-spec/#sources-image) for detailed documentation of options.)
 *
 * @example
 * // add to map
 * map.addSource('some id', {
 *    type: 'image',
 *    url: 'https://www.u-n-l.github.io/images/foo.png',
 *    coordinates: [
 *        [-76.54, 39.18],
 *        [-76.52, 39.18],
 *        [-76.52, 39.17],
 ...
 *    url: 'https://www.u-n-l.github.io/images/bar.png',
 *    coordinates: [
 *        [-76.54335737228394, 39.18579907229748],
 *        [-76.52803659439087, 39.1838364847587],
 *        [-76.5295386314392, 39.17683392507606],
...
class ImageSource extends Evented implements Source {
  ...
  load(newCoordinates?: Coordinates, successCallback?: () => void) {
    ...
    getImage(
      this.map._requestManager.transformRequest(this.url, ResourceType.Image),
      (err, image) => {
        this._loaded = true;
        if (err) {
  ...
  setCoordinates(coordinates: Coordinates) {
    ...
    // tile.
    const tileCoords = cornerCoords.map((coord) =>
